...
\keywords{context aware recommendation systems, online review mining, missing not at random, probabilistic graphic model,  utility surplus}
...
\includegraphics[width=0.23\textwidth]{data.eps}\label{fig:dis}}
\subfigure[Distribution of features]{
\includegraphics[width=0.23\textwidth]{feature.eps}\label{fig:feat}}
...
\includegraphics[width=0.25\textwidth]{classifier.eps}\label{fig:classifier}}
\subfigure[$D_{KL}$ with different sample sizes]{
\includegraphics[width=0.25\textwidth]{KL.eps}\label{fig:KL}}
